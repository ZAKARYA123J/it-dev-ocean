        ...
        <div className="bg-gradient-to-r from-transparent via-gray-800/50 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-gray-300 pb-8">
              Discover tools and resources to streamline your team's workflow
            ...
            <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
              ...
              <a
                  ...
                  href="https://wa.me/+212663116836?text=Hello%2C%20I%20would%20like%20to%20request%20consultation%20for%20your%20services."
                  target="_blank"
